...
public class JsonSerializationTests
{
    ...
    public void TestJsonExtendedCharacters()
    {
        ...
        TestContext.Current.TestOutputHelper?.WriteLine(roundtripJson);

        roundtripJson.Should().Contain("你好");

        // https://github.com/KhronosGroup/glTF/issues/1978#issuecomment-831744624
        // roundtripJson.Should().Contain("extended%20%E4%BD%A0%E5%A5%BD%20characters.png");

        roundtripModel.LogicalImages[0].Content.IsPng.Should().BeTrue();
    }
}
