...
using VERTEX = CodeBrix.Graphics3D.Gltf2.Geometry.VertexBuilder<CodeBrix.Graphics3D.Gltf2.Geometry.VertexTypes.VertexPositionNormal, CodeBrix.Graphics3D.Gltf2.Geometry.VertexTypes.VertexColor1Texture1, CodeBrix.Graphics3D.Gltf2.Geometry.VertexTypes.VertexEmpty>;

namespace CodeBrix.Graphics3D.Gltf2.Geometry.Parametric; //was previously: SharpGLTF.Geometry.Parametric;
