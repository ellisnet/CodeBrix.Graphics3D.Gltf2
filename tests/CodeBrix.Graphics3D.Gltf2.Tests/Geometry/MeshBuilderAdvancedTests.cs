...
using Xunit;
using VEMPTY = CodeBrix.Graphics3D.Gltf2.Geometry.VertexTypes.VertexEmpty;
using VPOS = CodeBrix.Graphics3D.Gltf2.Geometry.VertexTypes.VertexPosition;
using VPOSNRM = CodeBrix.Graphics3D.Gltf2.Geometry.VertexTypes.VertexPositionNormal;
using VSKIN4 = CodeBrix.Graphics3D.Gltf2.Geometry.VertexTypes.VertexJoints4;
...
public class MeshBuilderAdvancedTests
{
    ...
    public void CreateSceneWithMeshBuilder()
    {
        ...
        scene.AttachToCurrentTest("result.obj");
    }
    ...
    public void CreateSceneWithSharedBuffers()
    {
        ...
        var meshBuilder1 = new MeshBuilder<VPOSNRM>("mesh1");
            meshBuilder1.VertexPreprocessor.SetValidationPreprocessors();
        var meshBuilder2 = new MeshBuilder<VPOSNRM>("mesh2");
            meshBuilder2.VertexPreprocessor.SetValidationPreprocessors();
        var meshBuilder3 = new MeshBuilder<VPOSNRM>("mesh3");
            meshBuilder3.VertexPreprocessor.SetValidationPreprocessors();
        var meshBuilder4 = new MeshBuilder<VPOSNRM>("mesh4");
            meshBuilder4.VertexPreprocessor.SetValidationPreprocessors();
        ...
        // checks
        model.LogicalBuffers.Should().HaveCount(1);
        model.LogicalBufferViews.Should().HaveCount(2);
        model.LogicalBufferViews[0].IsVertexBuffer.Should().BeTrue();
        model.LogicalBufferViews[1].IsIndexBuffer.Should().BeTrue();
        model.LogicalMaterials.Should().HaveCount(2);
    ...
    public void CreateSceneWithAnimatedMeshBuilder()
    {
        ...
        pivot.UseTranslation("track1").Keys.Should().HaveCount(4);
    ...
    public void CreateSceneWithTerrain()
    {
        ...
        // texture path
        var imagePath = ResourceInfo.From("PolyHaven/food_apple_01_nor_gl.jpg");
    ...
    public void CreateMeshWithRandomCubes()
    {
        ...
        scene.AttachToCurrentTest("cubes.obj");
    }
    ...
    public void CreateSceneWithFakeAnimatedVisibility()
    {
        ...
        cube.VertexPreprocessor.SetValidationPreprocessors();
