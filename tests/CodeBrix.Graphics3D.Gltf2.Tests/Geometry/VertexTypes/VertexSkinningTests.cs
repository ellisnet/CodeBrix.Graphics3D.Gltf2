...
using Xunit;
using VERTEXSKINNED4 = CodeBrix.Graphics3D.Gltf2.Geometry.VertexBuilder<CodeBrix.Graphics3D.Gltf2.Geometry.VertexTypes.VertexPosition, CodeBrix.Graphics3D.Gltf2.Geometry.VertexTypes.VertexEmpty, CodeBrix.Graphics3D.Gltf2.Geometry.VertexTypes.VertexJoints4>;
using VERTEXSKINNED8 = CodeBrix.Graphics3D.Gltf2.Geometry.VertexBuilder<CodeBrix.Graphics3D.Gltf2.Geometry.VertexTypes.VertexPosition, CodeBrix.Graphics3D.Gltf2.Geometry.VertexTypes.VertexEmpty, CodeBrix.Graphics3D.Gltf2.Geometry.VertexTypes.VertexJoints8>;
...
public class VertexSkinningTests
{
    ...
    public void TestSkinnedVertexEquality()
    {
        ...
        w1.Index0.Should().NotBe(w0.Index0);
        w1.Weight0.Should().NotBe(w0.Weight0);
    ...
    public void TestVertexSkinningDowngradeFrom8To4Joints()
    {
        ...
        sparse.WeightSum.Should().BeApproximately(1, 0.00001f);

        sparse[5].Should().BeApproximately(0.333333f, 0.00001f);
        sparse[3].Should().BeApproximately(0.277777f, 0.00001f);
        sparse[1].Should().BeApproximately(0.222222f, 0.00001f);
        sparse[2].Should().BeApproximately(0.166666f, 0.00001f);
    }
}
