...
using SCHEMA2NODE = CodeBrix.Graphics3D.Gltf2.Scenes.Schema2SceneBuilder.IOperator<CodeBrix.Graphics3D.Gltf2.Schema2.Node>;
using SCHEMA2SCENE = CodeBrix.Graphics3D.Gltf2.Scenes.Schema2SceneBuilder.IOperator<CodeBrix.Graphics3D.Gltf2.Schema2.Scene>;
