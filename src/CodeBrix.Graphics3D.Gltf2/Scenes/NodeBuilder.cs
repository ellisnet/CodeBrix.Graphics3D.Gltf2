...
using TRANSFORM = CodeBrix.Graphics3D.Gltf2.Transforms.AffineTransform;
...
public class NodeBuilder : BaseBuilder
{
    ...
    /// <param name="reason">When the method returns false, a short description of why the joints are not valid; otherwise null.</param>
