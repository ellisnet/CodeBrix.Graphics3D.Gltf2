...
using System.Linq;
using System.Text;
using TARGET = CodeBrix.Graphics3D.Gltf2.IO.JsonSerializable;
...
public readonly struct ValueLocation
{
    ...
    [System.Diagnostics.CodeAnalysis.UnconditionalSuppressMessage("Trimming", "IL2075", Justification = "Diagnostic text only; when trimming removes the member the lookup returns null and the method falls back.")]
